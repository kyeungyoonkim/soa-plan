...
const STORAGE_KEY = "soa-asa-plan-v6";
    ...
    const PHASES = [
      ...
      { id:"sem1", name:"1학기 (Fall Y1)", period:"2026년 8/24 ~ 12/15", start:"2026-08-24", end:"2026-12-15", tasks:[
        ...
        { id:"proj-health", text:"Health rate memo (SAS) 시작", meta:"P 끝난 뒤(9/22~) · 10월 해커톤과 동일 작업으로", highlight:true },
        { id:"sas-hackathon", text:"SAS Student Hackathon", meta:"10월 중 · 신청 완료 · Health 포폴과 묶기", highlight:true },
        { id:"proj-life", text:"Life term memo (가정 문서)", meta:"5101(FM) 진도와 병행 · 해커톤 이후 본격", highlight:true },
    ...
    const REQUIREMENTS = [
      ...
      { id:"sas-hackathon", cat:"career", name:"SAS Student Hackathon", method:"10월 중 · 신청 완료 · Health rate memo와 동일 스택으로 참가", when:"Fall Y1 · 10월", order:20 },
    ...
    const PERSONAL_PROJECTS = [
      ...
      },
      {
        ...
        when: "해커톤 이후(10월 말~) · 5101(FM)과 병행 · 기말 전 1p memo",
        tools: {
