...
let state;
    ...
    function renderExamStudyGuide() {
      ...
      if (getExamStatus("exam-p") === "failed") {
        ...
        el.innerHTML = `<div><span class="hours-big">350h</span> <span class="stat-sub">Exam P · 목표 <strong>9/20</strong> (window 9/10–21)</span></div>`;
        ...
        el.innerHTML = `<div><span class="hours-big">500h</span> <span class="stat-sub">Exam PA · <strong>2027년 4월 목표</strong> (5108 Spring 2027 병행 · SOA 일정 확인)</span></div>`;
      } else {
